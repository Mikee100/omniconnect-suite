...
export type CalendarProps = React.ComponentProps<typeof DayPicker> & {
  dayContent?: (props: DayContentProps) => React.ReactElement;
};

function Calendar({ className, classNames, showOutsideDays = true, dayContent, ...props }: CalendarProps) {
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-12 w-12 p-0 font-normal aria-selected:opacity-100 text-sm"),
